...
<form method="POST" enctype="multipart/form-data">
	...
	<div class="Total_Soft_Cal_AMD">
		...
		<div class="Total_Soft_Cal_AMD2">
			<i class="Total_Soft_Help totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Click for Creating New Event', 'Total-Soft-Calendar' );?>"></i>
			<span class="Total_Soft_Cal_AMD2_But" onclick="Total_Soft_CalEv_AMD2_But1()">
				<?php esc_html_e( 'Create Event', 'Total-Soft-Calendar' );?>
			</span>
			<i class="Total_Soft_Cal_AMD2_But1 Total_Soft_Help totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Click for Reordering Events', 'Total-Soft-Calendar' );?>"></i>
		...
		<div class="Total_Soft_Cal_AMD3" onmouseover="Total_Soft_Cal_Desc_1()">
			...
			<i class="Total_Soft_Cal_Save_Ev Total_Soft_Help totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Click for Saving Settings', 'Total-Soft-Calendar' );?>"></i>
			...
			<i class="Total_Soft_Cal_Update_Ev Total_Soft_Help totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Click for Updating Settings', 'Total-Soft-Calendar' );?>"></i>
	...
	<table class="Total_Soft_AMOTable1">
		<?php for($i=0;$i<count($TotalSoftEvCount);$i++){
			...
			?> 
			<tr id="Total_Soft_AMOTable1_Calendar_tr_<?php echo esc_html($TotalSoftEvCount[$i]->id);?>">
				<td><?php echo esc_html($i+1);?></td>
				<td><?php echo esc_html($TotalSoftEvCount[$i]->TotalSoftCal_EvName);?></td>
				<td><?php echo esc_html($TotalSoft_Cal_Name[0]->TotalSoftCal_Name);?></td>
				<td><?php echo esc_html($TotalSoftEvCount[$i]->TotalSoftCal_EvStartDate);?></td>
				<td>
					<i title="Move" class="Total_Soft_icon totalsoft totalsoft-arrows" onmouseover="TotalSoftCal_EventSort()"></i>
					<input type="text" style="display: none;" name="TSoft_Cal_Move_ID_<?php echo esc_html($i+1);?>" value="<?php echo esc_html($TotalSoftEvCount[$i]->id);?>">
				</td>
				<td><i title="Clone" class="Total_Soft_icon totalsoft totalsoft-file-text" onclick="TotalSoftCal_EditCl(<?php echo esc_js($TotalSoftEvCount[$i]->id);?>)"></i></td>
				<td><i title="Edit" class="Total_Soft_icon totalsoft totalsoft-pencil" onclick="TotalSoftCal_EditEv(<?php echo esc_js($TotalSoftEvCount[$i]->id);?>)"></i></td>
				<td>
					<i title="Delete" class="TSoft_Cal_Ev_Move2 Total_Soft_icon totalsoft totalsoft-trash" onclick="TotalSoftCal_DelEv(<?php echo esc_js($TotalSoftEvCount[$i]->id);?>)"></i>
					<span class="Total_Soft_Calendar_Del_Span">
						<i class="Total_Soft_Calendar_Del_Span_Yes totalsoft totalsoft-check" onclick="TotalSoftCal_DelEv_Yes(<?php echo esc_js($TotalSoftEvCount[$i]->id);?>)"></i>
						<i class="Total_Soft_Calendar_Del_Span_No totalsoft totalsoft-times" onclick="TotalSoftCal_DelEv_No(<?php echo esc_js($TotalSoftEvCount[$i]->id);?>)"></i>
					</span>
				</td>
			</tr>
		<?php }?>
	...
	<table class="Total_Soft_AMEvTable" onmouseover="Total_Soft_Cal_Desc_1()">
		...
		<tr>
			<td><?php esc_html_e( 'Event Title', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'You can give a name for event.', 'Total-Soft-Calendar' );?>"></i></td>
			<td><input type="text" name="TotalSoftCal_EvName" id="TotalSoftCal_EvName" class="Total_Soft_Select" placeholder=" * <?php esc_html_e( 'Required', 'Total-Soft-Calendar' );?>"></td>
			<td><?php esc_html_e( 'Calendar Name', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose that version of calendar themes, in which you want to see the Events.', 'Total-Soft-Calendar' );?>"></i></td>
			<td>
				<select class="Total_Soft_Select" name="TotalSoftCal_EvCal" id="TotalSoftCal_EvCal">
					<?php for($i=0;$i<count($TotalSoftCalCount);$i++){?>
						<option value="<?php echo esc_html($TotalSoftCalCount[$i]->id);?>"><?php echo esc_html($TotalSoftCalCount[$i]->TotalSoftCal_Name);?></option>
					<?php }?>
		...
		<tr>
			<td><?php esc_html_e( 'Start Date', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the start of the event.', 'Total-Soft-Calendar' );?>"></i></td>
			<td><input type="date" class="Total_Soft_Select" name="TotalSoftCal_EvStartDate" id="TotalSoftCal_EvStartDate" placeholder="<?php esc_html_e( 'yyyy-mm-dd', 'Total-Soft-Calendar' );?>"></td>
			<td><?php esc_html_e( 'End Date', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the finish time of the event.', 'Total-Soft-Calendar' );?>"></i></td>
			<td><input type="date" class="Total_Soft_Select" name="TotalSoftCal_EvEndDate" id="TotalSoftCal_EvEndDate" placeholder="<?php esc_html_e( 'yyyy-mm-dd', 'Total-Soft-Calendar' );?>"></td>
		</tr>
		<tr>
			<td><?php esc_html_e( 'URL', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set external URL in the calendar, which should be included in the event.', 'Total-Soft-Calendar' );?>"></i></td>
			<td><input type="text" name="TotalSoftCal_EvURL" id="TotalSoftCal_EvURL" class="Total_Soft_Select" placeholder=" * <?php esc_html_e( 'Optional', 'Total-Soft-Calendar' );?>"></td>
			<td><?php esc_html_e( 'Open In New Tab', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose, by clicking on the link should open in new tab or not.', 'Total-Soft-Calendar' );?>"></i></td>
			<td>
		...
		<tr>
			<td><?php esc_html_e( 'Start Time', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the event start time.', 'Total-Soft-Calendar' );?>"></i></td>
			...
			<td><?php esc_html_e( 'End Time', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the event end time.', 'Total-Soft-Calendar' );?>"></i></td>
		...
		<tr>
			<td><?php esc_html_e( 'Event Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select that color, which you want to see for your event, which shows in the calendar.', 'Total-Soft-Calendar' );?>"></i></td>
		...
		<tr>
			...
			<td><?php esc_html_e( 'Recurring Time', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'You can set a period for event recur.', 'Total-Soft-Calendar' );?>"></i></td>
			<td>
		...
		<tr>
			<td colspan="4"><?php esc_html_e( 'Event Description', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'You can give a description for event.', 'Total-Soft-Calendar' );?>"></i></td>
		</tr>
		<tr>
			<td colspan="4">
