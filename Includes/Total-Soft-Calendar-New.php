<?php
	...
	wp_register_style( 'total_soft_calendar_fonts', plugins_url('../CSS/total_soft_calendar_fonts.css',__FILE__) );
	wp_enqueue_style( 'total_soft_calendar_fonts' );
	...
	$ts_calendar_fonts_array_res = "";
	foreach ($ts_calendar_fonts_array as $key => $value) {
		$ts_calendar_fonts_array_res .= sprintf(
			'
			  @font-face {
				font-family: "%1$s";
				font-style: normal;
	...
	wp_add_inline_style("total_soft_calendar_fonts", $ts_calendar_fonts_array_res);
?>
<form method="POST" oninput="TotalSoft_Cal_Out()">
	...
	<div class="Total_Soft_Cal_AMD">
		...
		<div class="Total_Soft_Cal_AMD2">
			<i class="Total_Soft_Help totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Click for Creating New Calendar', 'Total-Soft-Calendar' );?>"></i>
		...
		<div class="Total_Soft_Cal_AMD3">
			<i class="Total_Soft_Help totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Click for Canceling', 'Total-Soft-Calendar' );?>"></i>
			<span class="Total_Soft_Cal_AMD2_But" onclick="TotalSoft_Reload()">
				<?php esc_html_e( 'Cancel', 'Total-Soft-Calendar' );?>
			</span>
			<i class="Total_Soft_Cal_Update Total_Soft_Help totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Click for Updating Settings', 'Total-Soft-Calendar' );?>"></i>
	...
	<table class="Total_Soft_AMOTable">
		<?php for($i=0;$i<count($TotalSoftCalCount);$i++){
			...
			?> 
			<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo esc_html($TotalSoftCalCount[$i]->id);?>">
				<td><?php echo esc_html($i+1);?></td>
				<td><?php echo esc_html($TotalSoftCalCount[$i]->TotalSoftCal_Name);?></td>
				<td><?php echo esc_html(count($TotalSoft_Cal_Ev));?></td>
				<td><i class="Total_Soft_icon totalsoft totalsoft-file-text" onclick="TotalSoftCal_Clone(<?php echo esc_js($TotalSoftCalCount[$i]->id);?>)"></i></td>
				<td><i class="Total_Soft_icon totalsoft totalsoft-pencil" onclick="TotalSoftCal_Edit(<?php echo esc_js($TotalSoftCalCount[$i]->id);?>)"></i></td>
				<td>
					<i class="Total_Soft_icon totalsoft totalsoft-trash" onclick="TotalSoftCal_Del(<?php echo esc_js($TotalSoftCalCount[$i]->id);?>)"></i>
					<span class="Total_Soft_Calendar_Del_Span">
						<i class="Total_Soft_Calendar_Del_Span_Yes totalsoft totalsoft-check" onclick="Total_Soft_Cal_AMD2_But1(<?php echo esc_js($TotalSoftCalCount[$i]->id);?>)"></i>
						<i class="Total_Soft_Calendar_Del_Span_No totalsoft totalsoft-times" onclick="TotalSoftCalendar_Del_No(<?php echo esc_js($TotalSoftCalCount[$i]->id);?>)"></i>
					</span>
				</td>
			</tr>
		<?php }?>
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo esc_html($TotalSoftCalCount[$i]->id);?>">
			<td><?php echo esc_html($i+1);?></td>
			<td style="position: relative; height: 27px;">Crazy Calendar 1<img src="<?php echo esc_url(plugins_url('../Images/SUG-Pro.png',__FILE__));?>" style="position: absolute; top: 4px; right: 10px; width: 37px; height: 20px;"></td>
			<td>0</td>
		...
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo esc_html($TotalSoftCalCount[$i]->id);?>">
			...
			<td style="position: relative; height: 27px;">Crazy Calendar 2<img src="<?php echo esc_url(plugins_url('../Images/SUG-Pro.png',__FILE__));?>" style="position: absolute; top: 4px; right: 10px; width: 37px; height: 20px;"></td>
			<td>0</td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		...
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo esc_html($TotalSoftCalCount[$i]->id);?>">
			...
			<td style="position: relative; height: 27px;">Crazy Calendar 3<img src="<?php echo esc_url(plugins_url('../Images/SUG-Pro.png',__FILE__));?>" style="position: absolute; top: 4px; right: 10px; width: 37px; height: 20px;"></td>
			<td>0</td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		...
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo esc_html($TotalSoftCalCount[$i]->id);?>">
			...
			<td style="position: relative; height: 27px;">Schedule 1<img src="<?php echo esc_url(plugins_url('../Images/SUG-Pro.png',__FILE__));?>" style="position: absolute; top: 4px; right: 10px; width: 37px; height: 20px;"></td>
			<td>0</td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		...
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo esc_html($TotalSoftCalCount[$i]->id);?>">
			...
			<td style="position: relative; height: 27px;">Schedule 2<img src="<?php echo esc_url(plugins_url('../Images/SUG-Pro.png',__FILE__));?>" style="position: absolute; top: 4px; right: 10px; width: 37px; height: 20px;"></td>
			<td>0</td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		...
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo esc_html($TotalSoftCalCount[$i]->id);?>">
			<td><?php echo esc_html($i+6);?></td>
			<td style="position: relative; height: 27px;">Schedule 3<img src="<?php echo esc_url(plugins_url('../Images/SUG-Pro.png',__FILE__));?>" style="position: absolute; top: 4px; right: 10px; width: 37px; height: 20px;"></td>
			<td>0</td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		...
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo esc_html($TotalSoftCalCount[$i]->id);?>">
			<td><?php echo esc_html($i+7);?></td>
			<td style="position: relative; height: 27px;">Full Year Calendar 1<img src="<?php echo esc_url(plugins_url('../Images/SUG-Pro.png',__FILE__));?>" style="position: absolute; top: 4px; right: 10px; width: 37px; height: 20px;"></td>
			<td>0</td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		...
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo esc_html($TotalSoftCalCount[$i]->id);?>">
			<td><?php echo esc_html($i+8);?></td>
			<td style="position: relative; height: 27px;">Full Year Calendar 2<img src="<?php echo esc_url(plugins_url('../Images/SUG-Pro.png',__FILE__));?>" style="position: absolute; top: 4px; right: 10px; width: 37px; height: 20px;"></td>
			<td>0</td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		...
		<tr id="Total_Soft_AMOTable_Calendar_tr_<?php echo esc_html($TotalSoftCalCount[$i]->id);?>">
			<td><?php echo esc_html($i+9);?></td>
			<td style="position: relative; height: 27px;">Full Year Calendar 3<img src="<?php echo esc_url(plugins_url('../Images/SUG-Pro.png',__FILE__));?>" style="position: absolute; top: 4px; right: 10px; width: 37px; height: 20px;"></td>
			<td>0</td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Cal_AMD2_But1(1)"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
	...
	<div class="TS_Cal_Option_Div_Set TS_Cal_Option_Divv" id="Total_Soft_AMSetTable_Main">
		<div class="TS_Cal_Option_Divv1">
			<div class="TS_Cal_Option_Div1">
				<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Calendar Name', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Define the calendar name, in which, the events should be placed.', 'Total-Soft-Calendar' );?>"></i></div>
				<div class="TS_Cal_Option_Field">
					<input type="text" name="TotalSoftCal_Name" id="TotalSoftCal_Name" class="Total_Soft_Select" required placeholder=" * <?php esc_html_e( 'Required', 'Total-Soft-Calendar' );?>">
				</div>
			</div>
		</div>
		<div class="TS_Cal_Option_Divv2">
			<div class="TS_Cal_Option_Div1">
				<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Calendar Type', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Define the calendar type, in which, the events should be placed.', 'Total-Soft-Calendar' );?>"></i></div>
				<div class="TS_Cal_Option_Field">
	...
	<div class="Total_Soft_Cal_AMSetDiv" id="Total_Soft_Cal_AMSetDiv_1">
		...
		<div class="Total_Soft_Cal_AMSetDiv_Content">
			<div class="TS_Cal_Option_Div" id="Total_Soft_Cal_AMSetTable_1_GO">
				<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'General Options', 'Total-Soft-Calendar' );?></div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'WeekDay Start', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select that day in the calendar, which must be the first in the week.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose main background color in calendar.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
						<input type="text" name="TotalSoftCal_BgCol" id="TotalSoftCal_BgCol" class="Total_Soft_Cal_Color" value="">
					</div>
				</div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Grid Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select grid color which divides the days in the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
						<input type="text" name="TotalSoftCal_GrCol" id="TotalSoftCal_GrCol" class="Total_Soft_Cal_Color" value="">
					</div>
				</div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Grid Width', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the grid width, you can choose it corresponding  to your calendar.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Border Width', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Define the main border width.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Border Style', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Specify the border style: None, Solid, Dashed and Dotted.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Border Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the main border color.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
						<input type="text" name="TotalSoftCal_BCol" id="TotalSoftCal_BCol" class="Total_Soft_Cal_Color" value="">
					</div>
				</div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Max Width', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Define the calendar width.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Numbers Position', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Mention, the days in calendar must be from right or from left.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Shadow Type', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the shadow type.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Shadow Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the color, which allows to show the shadow color of the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_1_HO">
				<div class="TS_Cal_Option_Divv1">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Header Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose a background color, where can be seen the year and month.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal_HBgCol" id="TotalSoftCal_HBgCol" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose a text color, where can be seen the year and month.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal_HCol" id="TotalSoftCal_HCol" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the text size by pixel.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Family', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the calendar font family of the year and month.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<select class="Total_Soft_Select" name="TotalSoftCal_HFF" id="TotalSoftCal_HFF">
								<?php for($i = 0; $i < count($TotalSoftFontCount); $i++) { ?>
									<option value='<?php echo esc_html($TotalSoftFontCount[$i]);?>' style="font-family: <?php echo esc_html($TotalSoftFontCount[$i]);?>;"><?php echo esc_html($TotalSoftFontCount[$i]);?></option>
								<?php } ?>
							</select>
						</div>
					</div>
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles Total_Soft_Titles1"><?php esc_html_e( 'Weekday Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose a background color for weekdays.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal_WBgCol" id="TotalSoftCal_WBgCol" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the calendar text color for the weekdays.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal_WCol" id="TotalSoftCal_WCol" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the calendar text size for the weekdays.', 'Total-Soft-Calendar' );?> "></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Family', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the font family of the weekdays.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Divv2">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Line After Weekday', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Width', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the weeks and days dividing line width.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Style', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Indicate the dividing line style: None, Solid, Dashed and Dotted.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the color according to your preference.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_1_DO">
				<div class="TS_Cal_Option_Divv1">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Days Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the background for days of the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal_DBgCol" id="TotalSoftCal_DBgCol" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the color of the numbers.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal_DCol" id="TotalSoftCal_DCol" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Note the size of the numbers, it is fully responsive.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles Total_Soft_Titles1"><?php esc_html_e( 'Hover Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the background color of the hover option, without clicking you can change the background color of the day.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal_HovBgCol" id="TotalSoftCal_HovBgCol" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( "Determine the color of the hover's letters.", 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Divv2">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Todays Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Note the background color of the day.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal_TBgCol" id="TotalSoftCal_TBgCol" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the date color, that will be displayed.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal_TCol" id="TotalSoftCal_TCol" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the size of the numbers by pixels.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( "Number's Background Color", 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the background color of the day, it is designed for the frame.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_1_IO">
				<div class="TS_Cal_Option_Divv1">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Arrows Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Choose Icon', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the right and the left icons, which are for change the months by sequence.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select a color of the icon.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal_ArrowCol" id="TotalSoftCal_ArrowCol" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the size.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Divv2">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Refresh Icon Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose a color for updating icon, which has intended to return to the calendar from the events.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal_RefIcCol" id="TotalSoftCal_RefIcCol" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose a size for updating icon, which has intended to return to the calendar from the events.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Back To Main Calendar', 'Total-Soft-Calendar' );?></div>
			...
			<div class="TS_Cal_Option_Div" id="Total_Soft_Cal_AMSetTable_1_ET">
				<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Title Options', 'Total-Soft-Calendar' );?></div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the font size of the event title.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Family', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the font family for the title.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the color for the event title in the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
						<input type="text" name="TotalSoftCal1_Ev_T_C" id="TotalSoftCal1_Ev_T_C" class="Total_Soft_Cal_Color1" value="">
					</div>
				</div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Text Align', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Left, Right & Center - Determine the alignment of the event title.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Time Format', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose time format for the event in the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div" id="Total_Soft_Cal_AMSetTable_1_IV">
				<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Image/Video Options', 'Total-Soft-Calendar' );?></div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Width', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the width for Video (YouTube and Vimeo) or Image, you can choose it corresponding to your calendar.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Position', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose position for the Video and Image in event.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
	...
	<div class="Total_Soft_Cal_AMSetDiv" id="Total_Soft_Cal_AMSetDiv_2">
		...
		<div class="Total_Soft_Cal_AMSetDiv_Content">
			<div class="TS_Cal_Option_Div" id="Total_Soft_Cal_AMSetTable_2_GO">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Height', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Define the calendar height.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Shadow', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose to show the shadow or no.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_2_HO">
				<div class="TS_Cal_Option_Divv1">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Header Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select a background color, where can be seen the year and month.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal2_MBgC" id="TotalSoftCal2_MBgC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select a text color, where can be seen the year and month.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_2_DO">
				<div class="TS_Cal_Option_Divv1">
					...
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles Total_Soft_Titles1"><?php esc_html_e( 'Todays Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Note the background color of the current day.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal2_TdBgC" id="TotalSoftCal2_TdBgC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the current date color, that will be displayed.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles Total_Soft_Titles1"><?php esc_html_e( 'Event Days Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the background for event days.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Divv2">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Hover Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the background color of the hover option, without clicking you can change the background color of the day.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles Total_Soft_Titles1"><?php esc_html_e( 'Other Months Days Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the background color for the other months days on the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal2_OmBgC" id="TotalSoftCal2_OmBgC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the text color of the other months days.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal2_OmC" id="TotalSoftCal2_OmC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the size for the other months days on the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div" id="Total_Soft_Cal_AMSetTable_2_IO">
				<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Arrows Options', 'Total-Soft-Calendar' );?></div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Type', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the right and the left icons for calendar, which are for change the months by sequence.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the size for icon.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_2_EP">
				<div class="TS_Cal_Option_Divv1">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Header Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the background color of event part header, where can be seen the events main title.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal2_Ev_HBgC" id="TotalSoftCal2_Ev_HBgC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the text color of event part header, where can be seen the events main title.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Family', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the font family.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Text', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'You can write events main title.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" class="Total_Soft_Select" name="TotalSoftCal2_Ev_HText" id="TotalSoftCal2_Ev_HText" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles Total_Soft_Titles1"><?php esc_html_e( 'Body Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose a background color for events.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Divv2">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Date Format', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose Date format for the event in the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Show Date', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose to Show Date in event part or not.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
	...
	<div class="Total_Soft_Cal_AMSetDiv" id="Total_Soft_Cal_AMSetDiv_3">
		...
		<div class="Total_Soft_Cal_AMSetDiv_Content">
			<div class="TS_Cal_Option_Div" id="Total_Soft_Cal_AMSetTable_3_GO">
				<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'General Options', 'Total-Soft-Calendar' );?></div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Max-Width', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Possibility define the calendar width', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Can choose main background color.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
						<input type="text" name="" id="TotalSoftCal3_BgC" class="Total_Soft_Cal_Color" value="">
					</div>
				</div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Grid Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select grid color which divide the days in the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
						<input type="text" name="" id="TotalSoftCal3_GrC" class="Total_Soft_Cal_Color" value="">
					</div>
				</div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Body Border Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the body border color.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Shadow Type', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the shadow type.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Shadow Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the color, which allows to show the shadow color of the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_3_HO">
				<div class="TS_Cal_Option_Divv1">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Header Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select a background color, where can be seen the year and month.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_H_BgC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Border-Top Width', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the main top border width.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Border-Top Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the main top border color.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Month Font Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the calendar font size of the month.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Month Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the calendar text color for the month.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_H_MC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Year Font Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the calendar font size of the year.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Year Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the calendar text color for the year.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_H_YC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Format', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose position for the month and year.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles Total_Soft_Titles1"><?php esc_html_e( 'Line After Header', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Width', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the header line width.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the color according to your preference.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Divv2">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Arrows Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Type', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the right and the left icons for calendar, which are for change the months by sequence.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select a color of the icon.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Hover Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select a hover color of the icon.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles Total_Soft_Titles1"><?php esc_html_e( 'WeekDay Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose a background color for weekdays.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_WD_BgC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the calendar text color for the weekdays.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_3_DO">
				<div class="TS_Cal_Option_Divv1">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Days Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the background color for days of the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_D_BgC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the color of the numbers.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles Total_Soft_Titles1"><?php esc_html_e( 'Todays Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Note the background color of the current day.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_TD_BgC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the current date color, that will be displayed.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Divv2">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Hover Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the background color of the hover option, without clicking you can change the background color of the day.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_HD_BgC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( "Determine the color of the hover's letters.", 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles Total_Soft_Titles1"><?php esc_html_e( 'Event Days Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the event color for days.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_ED_C" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Hover Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the event hover color for days.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_3_EH">
				<div class="TS_Cal_Option_Divv1">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Header Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Format', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose date format.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Border-Top Width', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the main top border width for the event.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Border-Top Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the main top border color for the event.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_Ev_BTC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the background color of event part header, where can be seen the events main title.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_Ev_BgC" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the text color of event part header, where can be seen the events main title.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_Ev_C" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the font size for event in the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Family', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the font family for event in the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles Total_Soft_Titles1"><?php esc_html_e( 'Line After Header', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Width', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the line width for the events.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Divv2">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Close Icon Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Type', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the close icons for calendar, which has intended to return to the calendar from the events.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose a color for close icon, which has intended to return to the calendar from the events.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_Ev_C_C" class="Total_Soft_Cal_Color1" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Hover Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose a hover color for close icon, which has intended to return to the calendar from the events.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Border Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the body border color in the event.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div" id="Total_Soft_Cal_AMSetTable_3_ET">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose a background color for events title.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
						<input type="text" name="" id="TotalSoftCal3_Ev_T_BgC" class="Total_Soft_Cal_Color1" value="">
					</div>
				</div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the color for the event title in the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Time Format', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose time format for the event in the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Date Format', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose Date format for the event in the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div" id="Total_Soft_Cal_AMSetTable_3_IV">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Position', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose position for the Video and Image in event.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_3_LL">
				<div class="TS_Cal_Option_Divv1">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Link Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the color for the event link in the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_Ev_L_C" class="Total_Soft_Cal_Color1" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Hover Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the hover color for the event link in the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_Ev_L_HC" class="Total_Soft_Cal_Color1" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Position', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose position for the link in event.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Text', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'You can write link text.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal3_Ev_L_Text" id="TotalSoftCal3_Ev_L_Text" class="Total_Soft_Select" placeholder="<?php esc_html_e( 'Link Text', 'Total-Soft-Calendar' );?>">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the text font size for the link button of the event.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Family', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the font family for the link button.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Border Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the border color, which is designed for Link button.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal3_Ev_L_BC" class="Total_Soft_Cal_Color1" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Border Width', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the border width for the link buttons.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Border Radius', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Install the border radius for event link.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Divv2">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Line After Each Event', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Width', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the line width.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
	...
	<div class="Total_Soft_Cal_AMSetDiv" id="Total_Soft_Cal_AMSetDiv_4">
		...
		<div class="Total_Soft_Cal_AMSetDiv_Content">
			<div class="TS_Cal_Option_Div" id="Total_Soft_Cal_AMSetTable_4_GO">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Border Type', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Specify the border style: None, Solid, Dashed and Dotted.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Border Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the main border color.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_4_HO">
				<div class="TS_Cal_Option_Divv1">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Header Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Type', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Specify the background type: transparent, color or gradient types.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color 1', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the background color of header, where can be seen the year and month name.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal4_08" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color 2', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose second background color for gradient effects.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal4_09" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the calendar text size for the year and month name in header.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Family', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the font family of the year and month name in header.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Format', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select format to show years and months in header.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles Total_Soft_Titles1"><?php esc_html_e( 'Month Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the color for month name according to your preference.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Divv2">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Year Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the color for year according to your preference.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal4_13" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Arrow Type', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the right and the left icons for calendar, which are for changing the years by sequence.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Arrow Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the size for icon.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Arrow Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select a color of the icon.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal4_16" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Arrow Hover Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select a hover color of the icon.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Width', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the header line width by percentage.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Height', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the header line height by pixels.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_4_BO">
				<div class="TS_Cal_Option_Divv1">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Bar Options', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Type', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Specify the background type: transparent, color or gradient types.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color 1', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the background color of events bar, where can be seen the events dates.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Grid Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select grid color which divide the dates in the events bar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal4_25" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Number Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the calendar text size for dates in events bar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Number Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the color according to your preference for dates in events bar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal4_27" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Month Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the calendar text size for month names in events bar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Month Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the color according to your preference for month names in events bar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal4_29" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Selected Number Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the color according to your preference for dates for selected dates.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal4_30" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Selected Month Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the color according to your preference for month names for selected dates.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="" id="TotalSoftCal4_31" class="Total_Soft_Cal_Color" value="">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Arrow Type', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the right and the left icons for calendar, which are for changing the events by sequence.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Divv2">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Line After Bar', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the color according to your preference.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Width', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the bar line width by percentage.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Height', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the bar line height by pixels.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_4_EP">
				<div class="TS_Cal_Option_Divv1">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Background Color 1', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the background color of event part, where can be seen the events with description and media.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Data Format', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose data format for the event in the calendar.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Divv2">
					<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Event Title', 'Total-Soft-Calendar' );?></div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the font size of the event title.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div TS_Cal_Option_Divv" id="Total_Soft_Cal_AMSetTable_4_LL">
				<div class="TS_Cal_Option_Divv1">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Text', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'You can write link text.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
							<input type="text" name="TotalSoftCal_4_15" id="TotalSoftCal_4_15" class="Total_Soft_Select" placeholder="<?php esc_html_e( 'Link Text', 'Total-Soft-Calendar' );?>">
						</div>
					</div>
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the text font size for the link button of the event.', 'Total-Soft-Calendar' );?>"></i></div>
				...
				<div class="TS_Cal_Option_Divv2">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Width', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the line width by percentage.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
					...
					<div class="TS_Cal_Option_Div1">
						<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Height', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Determine the line height by pixels.', 'Total-Soft-Calendar' );?>"></i></div>
						<div class="TS_Cal_Option_Field">
			...
			<div class="TS_Cal_Option_Div" id="Total_Soft_Cal_AMSetTable_4_DT">
				<div class="TS_Cal_Option_Div1 Total_Soft_Titles"><?php esc_html_e( 'Date & Time Options', 'Total-Soft-Calendar' );?></div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the color for the date and time in event.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
						<input type="text" name="" id="TotalSoftCal_4_24" class="Total_Soft_Cal_Color1" value="">
					</div>
				</div>
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the calendar text size for the date & time in event.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Font Family', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Choose the font family of the date & time in event.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Icon Type', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select the icon for calendar for event part.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Icon Size', 'Total-Soft-Calendar' );?> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Set the size for icon.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
				...
				<div class="TS_Cal_Option_Div1">
					<div class="TS_Cal_Option_Name"><?php esc_html_e( 'Icon Color', 'Total-Soft-Calendar' );?> <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="<?php esc_html_e( 'Select a color of the icon.', 'Total-Soft-Calendar' );?>"></i></div>
					<div class="TS_Cal_Option_Field">
